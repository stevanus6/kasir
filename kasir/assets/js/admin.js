...
var loading = function() {
    let element = "";
    element += '<div class="preloader pl-size-sm">';
    element += '<div class="spinner-layer pl-blue">';
    element += '<div class="circle-clipper left">';
    element += '<div class="circle"></div>';
    element += '</div>';
    element += '<div class="circle-clipper right">';
    element += '<div class="circle"></div>';
    element += '</div>';
    element += '</div>';
    element += '</div>';
